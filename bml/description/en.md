...
- Support custom localizations, language files can be found in/resource/lang
- Now compatible with [Richer information display](https://steamcommunity.com/sharedfiles/filedetails/?id=3612733981), can display specific information about affixes
- Now compatible with [Arcane Era](https://steamcommunity.com/sharedfiles/filedetails/?id=3610458453) Add 4 spell specific affixes, which can be disabled in the settings
- Now supports automatic recasting of shortcut keys, **Note that it will recast the item you currently left clicked selecting!**, shortcut keys can be changed in the settings
